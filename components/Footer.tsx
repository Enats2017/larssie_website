...
import logoImg from "@/assets/Trail_logo.png";
            ...
            <div className="bg-[#36A5DD] lg:bg-white lg:border-t lg:border-gray-200 py-6 mx-4 lg:mx-0 rounded-2xl lg:rounded-none mb-4 lg:mb-0">
              <div className="max-w-[1280px] mx-auto px-6 md:px-10">
                <div className="w-full grid grid-cols-1 lg:grid-cols-[auto_1px_auto_1px_auto_auto] lg:items-center gap-x-6 gap-y-4 lg:gap-y-6">
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-start gap-3 lg:flex-wrap">
                        <a href="#"
                            className="inline-flex items-center gap-2 bg-white lg:bg-[#36A5DD] text-[#36A5DD] lg:text-white font-bold rounded-full px-8 py-4 hover:opacity-90 transition-opacity text-[17px] whitespace-nowrap">
                            Register Now
                            <Image src={arrowBlue} alt="arrow" width={26} height={26} />
                        </a>
                        <a href="#"
                            className="inline-flex items-center gap-2 bg-[#002248] text-white font-bold rounded-full px-8 py-4 hover:bg-[#001530] transition-colors text-[17px] whitespace-nowrap">
                            Become Member
                    ...
                    <div className="flex flex-row items-center justify-start gap-4 lg:col-span-2">
                        <Image src={mailImg} alt="Mail Us" width={65} height={65} />
                        <div className="flex flex-col">
                            <span className="text-white lg:text-[#002248] font-bold text-[30px] leading-tight">Mail Us:</span>
                            <a href="mailto:info@trailrunning.com"
                                className="text-white lg:text-[#36A5DD] font-medium text-[22px] leading-tight hover:underline break-all">
